    ...
    public partial class JobListing : System.Web.UI.Page
    {
        ...
        private void showJobList()
        {
            if (dt == null)
            {
                ...
                string query = @"Select JobId,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs";
        ...
        protected void ddlState_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select JobId,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs where State ='" + ddlState.SelectedValue + "' ";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void ddlCity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select JobId,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs where City ='" + ddlCity.SelectedValue + "' ";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select JobId,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs where JobType IN (" + jobType + ")";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (RadioButtonList1.SelectedValue != "0")
            {
                ...
                con = new SqlConnection(str);
                string query = @"Select JobId,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs where Convert(DATE,CreateDate)" + postedDate + " ";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        string selectedRadioButton()
        {
            ...
            {
                postedDate = " between Convert(DATE,'" + DateTime.Now.AddDays(-15).ToString("yyyy/MM/dd") + "') and Convert(DATE, '" + date.ToString("yyyy/MM/dd") + "') ";
            }
            else
            {
                postedDate = " between Convert(DATE,'" + DateTime.Now.AddDays(-20).ToString("yyyy/MM/dd") + "') and Convert(DATE, '" + date.ToString("yyyy/MM/dd") + "') ";
            }
            return postedDate;
        }
        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlState.SelectedValue != "0")
                {
                    queryList.Add(" State ='" + ddlState.SelectedValue + "' ");
                    isCondition = true;
                }
                ...
                if (isCondition)
                {
                    ...
                    query = @"Select JobID,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs where " + subquery + " ";
                }
                else
                {
                    query = @"Select JobID,JobTitle,Salary,JobType,CompanyName,CompanyLogo,State,City,CreateDate from Jobs";
                }
