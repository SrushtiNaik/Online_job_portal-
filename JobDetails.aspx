...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
        ...
        <div class="job-post-company pt-120 pb-120">
            <div class="container">
                <asp:DataList ID="DataList1" OnItemCommand="DataList1_ItemCommand" OnItemDataBound="DataList1_ItemDataBound" runat="server">
                    <ItemTemplate>
                        ...
                        <div class="single-job-items mb-50">
                            <div class="job-items">
                                <div class="company-img company-img-details">
                                    <a href="#"><img src="<%# GetImageUrl(Eval("CompanyLogo")) %>" width="80" alt=""></a>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="post-details4  mb-50">
                           ...
                           <div class="small-section-tittle">
                              ...
                              <p><b>Job Roles: </b><%# Eval("JobRoles") %></p>
                            <ul>
                                <li>Name: <span><%# Eval("CompanyName") %></span></li>   
                                <li>Location: <span><%# Eval("Location") %></span></li>
                                <li>Contact: <span><%# Eval("ContactNo") %></span></li>
