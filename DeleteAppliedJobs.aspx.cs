...
{
    public partial class DeleteAppliedJobs : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        DataTable dt;
        ...
        private void ShowAppliedJob()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No],aj.AppliedJobId,j.CompanyName,aj.JobId,j.JobTitle,u.ContactNo,
                        u.Username,u.EmailAddress,u.Resume from AppliedJobs aj
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                if (r > 0)
                {
                    lblMsg.Text = "Applied Job deleted Successfully!";
