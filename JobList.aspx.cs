...
namespace OnlineJobPortal.Admin
{
    public partial class JobList : System.Web.UI.Page
    {
        ...
        protected void Page_PreReader(object sender, EventArgs e)
        {
        ...
        private void ShowJob()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No], JobId, JobTitle, CompanyName, NoOfPost, Qualification, Experience, 
                    LastDateToApply, ContactNo, Salary, Location, State, City, CreateDate from Jobs";
